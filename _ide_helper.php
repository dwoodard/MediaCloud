 ...
 * Generated for Laravel 4.1.31 on 2015-04-03.
 *
...
namespace {
    ...
    class Breadcrumbs extends \DaveJamesMiller\Breadcrumbs\Facade{
        ...
        public static function getView(){
            return \DaveJamesMiller\Breadcrumbs\Manager::getView();
        }
        ...
        public static function generateArray($name, $args = array()){
            return \DaveJamesMiller\Breadcrumbs\Manager::generateArray($name, $args);
        }
        ...
        public static function renderArray($name, $args = array()){
            return \DaveJamesMiller\Breadcrumbs\Manager::renderArray($name, $args);
        }
